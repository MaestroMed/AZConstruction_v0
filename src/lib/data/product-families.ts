...
export const productFamilies: ProductFamily[] = [
  ...
  },
  {
    ...
    tagline: "Ombre & Élégance",
    description: "Pergolas acier sur mesure pour terrasses et jardins.",
    longDescription: "Nos pergolas en acier thermolaqué créent des espaces de vie extérieurs confortables et élégants. Bioclimatiques avec lames orientables ou classiques, elles s'adaptent à tous les styles architecturaux et à toutes les configurations de terrasse.",
    heroImages: defaultHeroImages,
    startingPrice: "",
    unit: "pièce",
    features: ["Bioclimatique", "Motorisation", "Acier thermolaqué", "Sur mesure"],
    benefits: [
      { icon: "Sparkles", title: "Design", description: "Valorisez votre terrasse avec une structure élégante." },
      { icon: "Shield", title: "Protection", description: "Protégez-vous du soleil et de la pluie." },
      { icon: "Zap", title: "Motorisation", description: "Lames orientables motorisées pour un confort optimal." },
      { icon: "Award", title: "Décennale", description: "Couverture décennale pour tous nos ouvrages." },
    ],
    variants: [
      { id: "bioclimatique", name: "Pergola Bioclimatique", description: "Lames orientables pour moduler lumière et ventilation.", features: ["Lames orientables", "Motorisation", "Capteur pluie option"], startingPrice: "" },
      { id: "adossee", name: "Pergola Adossée", description: "Fixée contre la façade de votre maison.", features: ["Structure légère", "Toile ou lames", "Gouttière intégrée"], startingPrice: "" },
      { id: "autoportante", name: "Pergola Autoportante", description: "Indépendante, positionnée librement dans le jardin.", features: ["4 pieds", "Toutes dimensions", "Îlot de fraîcheur"], startingPrice: "" },
    ],
    specifications: [
      { label: "Dimensions max.", value: "6m x 4m (ou plus sur étude)" },
      { label: "Structure", value: "Acier thermolaqué" },
      { label: "Couverture", value: "Lames alu, toile, polycarbonate" },
      { label: "Motorisation", value: "Somfy, télécommande" },
      { label: "Options", value: "Éclairage LED, stores latéraux" },
      { label: "Assurance", value: "Décennale" },
    ],
    gallery: [],
    seoTitle: "Pergolas Sur Mesure | Bioclimatique, Acier | AZ Construction",
    seoDescription: "Pergolas acier sur mesure. Bioclimatiques, adossées, autoportantes. Motorisation Somfy. Devis gratuit.",
  },
  {
    id: "marquises",
    slug: "marquises",
