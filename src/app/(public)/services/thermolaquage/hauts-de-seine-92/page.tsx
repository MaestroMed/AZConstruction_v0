...
export const metadata: Metadata = {
  title: "Thermolaquage Hauts-de-Seine (92) | Nanterre, Boulogne - AZ Construction",
  description:
    "Thermolaquage professionnel dans les Hauts-de-Seine (92). Intervention Nanterre, Boulogne-Billancourt, Colombes, Courbevoie. Devis gratuit ☎️ 09 71 35 74 96",
  keywords: [
    "thermolaquage hauts de seine",
    "thermolaquage 92",
    "thermolaquage nanterre",
    "thermolaquage boulogne billancourt",
    "thermolaquage colombes",
    "thermolaquage courbevoie",
    "peinture poudre 92",
  ],
  alternates: {
    canonical: "https://azconstruction.fr/services/thermolaquage/hauts-de-seine-92",
  },
  openGraph: {
    title: "Thermolaquage Hauts-de-Seine (92) | AZ Construction",
    description: "Thermolaquage professionnel dans les Hauts-de-Seine. Enlevement et livraison gratuits.",
    url: "https://azconstruction.fr/services/thermolaquage/hauts-de-seine-92",
...
const cities = [
  { name: "Nanterre", distance: "35 km" },
  { name: "Boulogne-Billancourt", distance: "40 km" },
  { name: "Colombes", distance: "30 km" },
  { name: "Courbevoie", distance: "32 km" },
  { name: "Asnieres-sur-Seine", distance: "28 km" },
  { name: "Rueil-Malmaison", distance: "38 km" },
  { name: "Levallois-Perret", distance: "30 km" },
  { name: "Issy-les-Moulineaux", distance: "42 km" },
  { name: "Neuilly-sur-Seine", distance: "32 km" },
  { name: "Antony", distance: "45 km" },
  { name: "Clichy", distance: "28 km" },
  { name: "Clamart", distance: "45 km" },
];
...
const advantages = [
  {
    ...
    description: "Nous venons chercher vos pieces dans tout le 92, sans frais supplementaires.",
  },
  {
    icon: Zap,
    title: "Delais Rapides",
    description: "Traitement express dans notre atelier. Retour sous 5-7 jours ouvres.",
  },
  {
    icon: Palette,
  ...
  },
  {
    ...
    description: "Nos traitements sont garantis contre l'ecaillage et la decoloration.",
  },
];
...
const testimonials = [
  {
    name: "Vincent D.",
    city: "Nanterre",
    text: "Excellent rapport qualite-prix. Le service d'enlevement est tres pratique.",
    rating: 5,
  },
  {
    name: "Isabelle G.",
    city: "Boulogne-Billancourt",
    text: "Tres belle finition sur mes volets metalliques. Couleur parfaite.",
    rating: 5,
  },
  {
    name: "Thomas L.",
    city: "Colombes",
    text: "Professionnels et reactifs. Je recommande pour tout projet de thermolaquage.",
    rating: 5,
  },
];

export default function ThermolaquageHautsDeSeinePage() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl">
            <nav className="flex items-center gap-2 text-sm text-white/60 mb-6">
              ...
              <span>/</span>
              <span className="text-cyan-glow">Hauts-de-Seine (92)</span>
            </nav>
            ...
            <div className="inline-flex items-center gap-2 bg-cyan-glow/20 border border-cyan-glow/30 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-cyan-glow text-sm font-medium">
                Intervention rapide dans le 92
              </span>
            </div>
            ...
            <p className="text-xl text-white/80 mb-8 max-w-2xl">
              Service de thermolaquage professionnel pour les Hauts-de-Seine. Enlevement
              et livraison gratuits sur Nanterre, Boulogne-Billancourt, Colombes et toutes
              les communes du 92.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-600 text-lg">
              Un service complet avec enlevement et livraison dans tout le departement.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-navy-dark mb-4">
              Communes Desservies dans le 92
            </h2>
            <p className="text-gray-600 text-lg">
              Enlevement et livraison disponibles dans toutes les communes des Hauts-de-Seine.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-glow to-blue-corporate">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-navy-dark mb-4">
            Besoin d'un Thermolaquage dans le 92 ?
          </h2>
          <p className="text-navy-dark/80 text-lg mb-8 max-w-2xl mx-auto">
            Contactez-nous pour un devis gratuit. Enlevement sous 48h.
          </p>
