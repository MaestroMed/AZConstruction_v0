...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.azconstruction.fr/services/thermolaquage",
  },
  openGraph: {
    ...
    url: "https://www.azconstruction.fr/services/thermolaquage",
...
const jsonLd = {
  ...
  "@graph": [
    ...
    {
      "@type": "LocalBusiness",
      "@id": "https://www.azconstruction.fr/#organization",
    ...
    {
      "@type": "Service",
      "@id": "https://www.azconstruction.fr/services/thermolaquage/#service",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.azconstruction.fr/services/thermolaquage/#faq",
      mainEntity: [
        {
          "@type": "Question",
    ...
    // BreadcrumbList
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 2,
          name: "Services",
          item: "https://www.azconstruction.fr/services",
        },
        {
          "@type": "ListItem",
          position: 3,
          name: "Thermolaquage",
          item: "https://www.azconstruction.fr/services/thermolaquage",
        },
      ],
    },
  ],
