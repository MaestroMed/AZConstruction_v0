...
export const metadata: Metadata = {
  title: "Thermolaquage Seine-et-Marne (77) | Meaux, Melun, Chelles - AZ Construction",
  description:
    "Thermolaquage professionnel en Seine-et-Marne (77). Intervention Meaux, Melun, Chelles, Pontault-Combault. Devis gratuit ☎️ 09 71 35 74 96",
  keywords: [
    "thermolaquage seine et marne",
    "thermolaquage 77",
    "thermolaquage meaux",
    "thermolaquage melun",
    "thermolaquage chelles",
    "thermolaquage pontault combault",
    "peinture poudre 77",
  ],
  alternates: {
    canonical: "https://azconstruction.fr/services/thermolaquage/seine-et-marne-77",
  },
  openGraph: {
    title: "Thermolaquage Seine-et-Marne (77) | AZ Construction",
    description: "Thermolaquage professionnel en Seine-et-Marne.",
    url: "https://azconstruction.fr/services/thermolaquage/seine-et-marne-77",
...
const cities = [
  { name: "Meaux", distance: "25 km" },
  { name: "Melun", distance: "65 km" },
  { name: "Chelles", distance: "30 km" },
  { name: "Pontault-Combault", distance: "40 km" },
  { name: "Savigny-le-Temple", distance: "55 km" },
  { name: "Torcy", distance: "35 km" },
  { name: "Roissy-en-Brie", distance: "38 km" },
  { name: "Villeparisis", distance: "22 km" },
  { name: "Bussy-Saint-Georges", distance: "40 km" },
  { name: "Lagny-sur-Marne", distance: "30 km" },
  { name: "Ozoir-la-Ferriere", distance: "42 km" },
  { name: "Lognes", distance: "38 km" },
];
...
const advantages = [
  {
    ...
    description: "Service d'enlevement dans tout le 77.",
  },
  {
    icon: Zap,
    title: "Proximite",
    description: "A 25 min de Meaux, intervention rapide.",
  },
  {
    icon: Palette,
    title: "200+ Couleurs",
    description: "Toute la gamme RAL disponible.",
  },
  {
    icon: Shield,
    title: "Garantie 10 Ans",
    description: "Qualite certifiee longue duree.",
  },
];
...
const testimonials = [
  {
    name: "Guillaume T.",
    city: "Meaux",
    text: "Tres content du resultat sur mes clotures. Travail soigne.",
    rating: 5,
  },
  {
    name: "Valerie S.",
    city: "Chelles",
    text: "Service rapide et professionnel. Prix competitif.",
    rating: 5,
  },
  {
    name: "Christophe B.",
    city: "Melun",
    text: "Excellente prestation, je recommande vivement.",
    rating: 5,
  },
];

export default function ThermolaquageSeineMarnePage() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl">
            <nav className="flex items-center gap-2 text-sm text-white/60 mb-6">
              ...
              <span>/</span>
              <span className="text-cyan-glow">Seine-et-Marne (77)</span>
            </nav>
            ...
            <div className="inline-flex items-center gap-2 bg-cyan-glow/20 border border-cyan-glow/30 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-cyan-glow text-sm font-medium">
                Intervention en Seine-et-Marne
              </span>
            </div>
            ...
            <p className="text-xl text-white/80 mb-8 max-w-2xl">
              Votre specialiste du thermolaquage en Seine-et-Marne. Service complet
              avec enlevement et livraison sur Meaux, Melun, Chelles et tout le 77.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-navy-dark mb-4">
              Communes Desservies dans le 77
            </h2>
          </div>
