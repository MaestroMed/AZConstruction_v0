...
export const metadata: Metadata = {
  title: "Thermolaquage Yvelines (78) | Versailles, Saint-Germain - AZ Construction",
  description:
    "Thermolaquage professionnel dans les Yvelines (78). Intervention Versailles, Saint-Germain-en-Laye, Sartrouville, Mantes. Devis gratuit ☎️ 09 71 35 74 96",
  keywords: [
    "thermolaquage yvelines",
    "thermolaquage 78",
    "thermolaquage versailles",
    "thermolaquage saint germain en laye",
    "thermolaquage sartrouville",
    "thermolaquage mantes la jolie",
    "peinture poudre 78",
  ],
  alternates: {
    canonical: "https://azconstruction.fr/services/thermolaquage/yvelines-78",
  },
  openGraph: {
    title: "Thermolaquage Yvelines (78) | AZ Construction",
    description: "Thermolaquage professionnel dans les Yvelines.",
    url: "https://azconstruction.fr/services/thermolaquage/yvelines-78",
...
const cities = [
  { name: "Versailles", distance: "50 km" },
  { name: "Saint-Germain-en-Laye", distance: "40 km" },
  { name: "Sartrouville", distance: "30 km" },
  { name: "Mantes-la-Jolie", distance: "45 km" },
  { name: "Conflans-Sainte-Honorine", distance: "25 km" },
  { name: "Poissy", distance: "35 km" },
  { name: "Chatou", distance: "35 km" },
  { name: "Le Chesnay", distance: "48 km" },
  { name: "Houilles", distance: "28 km" },
  { name: "Rambouillet", distance: "70 km" },
  { name: "Carrieres-sous-Poissy", distance: "32 km" },
  { name: "Plaisir", distance: "55 km" },
];
...
const advantages = [
  {
    ...
    description: "Nous venons chercher vos pieces dans tout le 78.",
  },
  {
    icon: Zap,
    title: "Delais Courts",
    description: "Traitement rapide, retour sous 5-7 jours ouvres.",
  },
  {
    icon: Palette,
    title: "Toutes Couleurs",
    description: "Plus de 200 teintes RAL disponibles.",
  },
  {
    icon: Shield,
    title: "Garantie 10 Ans",
    description: "Qualite professionnelle garantie longue duree.",
  },
];
...
const testimonials = [
  {
    name: "Francois B.",
    city: "Versailles",
    text: "Excellent travail sur mon portail. Finition impeccable.",
    rating: 5,
  },
  {
    name: "Sandrine V.",
    city: "Saint-Germain-en-Laye",
    text: "Service tres professionnel, je recommande vivement.",
    rating: 5,
  },
  {
    name: "Olivier R.",
    city: "Sartrouville",
    text: "Tres satisfait du resultat et du delai respecte.",
    rating: 5,
  },
];

export default function ThermolaquageYvelinesPage() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl">
            <nav className="flex items-center gap-2 text-sm text-white/60 mb-6">
              ...
              <span>/</span>
              <span className="text-cyan-glow">Yvelines (78)</span>
            </nav>
            ...
            <div className="inline-flex items-center gap-2 bg-cyan-glow/20 border border-cyan-glow/30 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-cyan-glow text-sm font-medium">
                Intervention dans les Yvelines
              </span>
            </div>
            ...
            <p className="text-xl text-white/80 mb-8 max-w-2xl">
              Specialiste du thermolaquage dans les Yvelines. Enlevement et livraison
              sur Versailles, Saint-Germain-en-Laye, Sartrouville et tout le 78.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-navy-dark mb-4">
              Nos Services pour les Yvelines
            </h2>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-navy-dark mb-4">
              Communes Desservies dans le 78
            </h2>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-glow to-blue-corporate">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-navy-dark mb-4">
            Devis Gratuit pour les Yvelines
          </h2>
          <p className="text-navy-dark/80 text-lg mb-8 max-w-2xl mx-auto">
            Contactez-nous pour votre projet de thermolaquage.
          </p>
