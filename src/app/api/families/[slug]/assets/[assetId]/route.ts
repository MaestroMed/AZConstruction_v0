...
/**
 * PATCH /api/families/[slug]/assets/[assetId]
 *
 * Update d'un asset (ex : reorder via `ordre`).
 */
export async function PATCH(
  ...
  try {
    ...
    const existing = await prisma.productFamilyAsset.findUnique({
      where: { id: assetId },
    });
    ...
    const data: Prisma.ProductFamilyAssetUpdateInput = {};
    ...
    const asset = await prisma.productFamilyAsset.update({
      where: { id: assetId },
      data,
    });
    ...
    console.error("[families/[slug]/assets/[assetId]] PATCH", err);
    return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    await prisma.productFamilyAsset.delete({ where: { id: assetId } });
    ...
    console.error("[families/[slug]/assets/[assetId]] DELETE", err);
    return NextResponse.json(
